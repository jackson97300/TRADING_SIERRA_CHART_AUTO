...
construit le pipeline complet, et produit un rapport avec:
  1. Tests fonctionnels (parité C++, NaN, sync, schema 250 cols)
...
Schema: 3.6.0 — 250 colonnes (244 + 6 RVOL)
...
MUST_VARY = [
    ('range_pos', 5), ('momentum_3b', 5), ('momentum_5b', 5),
    ('cvd_bar_delta', 5), ('bars_in_va', 5),

...
- [2026-05-02 01:50] **🚨 BLOCKER V5 — Leak mq_* pre-2026 dataset_builder.py:516** | 30 min fix | CRITIQUE | DOCUMENTÉ — `fillna(medians)` applique median 2026 sur bars 2011-2024 où mq_* = NaN → look-ahead massif. Fix Option A samedi 9h : restreindre V5 à 2024-2026. Cf DOCS/BLOCKER_MQ_LEAK_PRE2026.md. **AVANT V5 build samedi obligatoire**.
